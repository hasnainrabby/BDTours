...
public class DetailsActivityAhsanMonjil extends AppCompatActivity {
    ...
    int[] sampleImages = {
            R.drawable.ahsan_monjil1,
            R.drawable.ahsan_monjil2,
            R.drawable.ahsan_monjil3,
            R.drawable.ahsan_monjil4
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolBarTitle.setText("*** আহসান মঞ্জিল ***");
        ...
        InputStream inputStream = getResources().openRawResource(R.raw.ahsanmonjil_intro);
        ...
        inputStream = getResources().openRawResource(R.raw.ahsanmonjil_kivabejaben);
        ...
        inputStream = getResources().openRawResource(R.raw.ahsanmonjil_kivabepousaben);
        ...
        inputStream = getResources().openRawResource(R.raw.ahsanmonjil_kothaithakben);
        ...
        inputStream = getResources().openRawResource(R.raw.ahsanmonjil_khabar);
        ...
        inputStream = getResources().openRawResource(R.raw.ahsanmonjil_vromontips);
