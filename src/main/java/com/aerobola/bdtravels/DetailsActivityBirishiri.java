...
public class DetailsActivityBirishiri extends AppCompatActivity {
    ...
    int[] sampleImages = {
            R.drawable.birishiri1,
            R.drawable.birishiri2,
            R.drawable.birishiri3,
            R.drawable.birishiri4,
            R.drawable.birishiri5
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputStream inputStream = getResources().openRawResource(R.raw.birishiri_intro);
        ...
        inputStream = getResources().openRawResource(R.raw.birishiri_kivabejaben);
        ...
        inputStream = getResources().openRawResource(R.raw.birishiri_kivabepousaben);
        ...
        inputStream = getResources().openRawResource(R.raw.birishiri_kothaithakben);
        ...
        inputStream = getResources().openRawResource(R.raw.birishiri_khabar);
        ...
        inputStream = getResources().openRawResource(R.raw.birishiri_vromontips);
