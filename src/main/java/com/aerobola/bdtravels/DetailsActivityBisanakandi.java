...
public class DetailsActivityBisanakandi extends AppCompatActivity {
    ...
    int[] sampleImages = {
            R.drawable.bisanakandi1,
            R.drawable.bisanakandi2,
            R.drawable.bisanakandi3,
            R.drawable.bisanakandi4,
            R.drawable.bisanakandi6
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolBarTitle.setText("*** বিছানাকান্দি ***");
        ...
        InputStream inputStream = getResources().openRawResource(R.raw.bichanakandi_intro);
        ...
        inputStream = getResources().openRawResource(R.raw.bichanakandi_kivabejaben);
        ...
        inputStream = getResources().openRawResource(R.raw.bichanakandi_kivabepousaben);
        ...
        inputStream = getResources().openRawResource(R.raw.bichanakandi_kothyaithakben);
        ...
        inputStream = getResources().openRawResource(R.raw.bichanakandi_khabar);
        ...
        inputStream = getResources().openRawResource(R.raw.bichanakandi_vromontips);
