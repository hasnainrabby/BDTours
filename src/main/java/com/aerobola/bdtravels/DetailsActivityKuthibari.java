...
public class DetailsActivityKuthibari extends AppCompatActivity {
    ...
    int[] sampleImages = {
            R.drawable.kuthibari1,
            R.drawable.kuthibari4,
            R.drawable.kuthibari5,
            R.drawable.kuthibari6,
            R.drawable.kuthibari7
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputStream inputStream = getResources().openRawResource(R.raw.kuthibari_intro);
        ...
        inputStream = getResources().openRawResource(R.raw.kuthibari_kivabejaben);
        ...
        inputStream = getResources().openRawResource(R.raw.kuthibari_kivabepousaben);
        ...
        inputStream = getResources().openRawResource(R.raw.kuthibari_kothaithakben);
        ...
        inputStream = getResources().openRawResource(R.raw.kuthibari_khabar);
        ...
        inputStream = getResources().openRawResource(R.raw.kuthibari_vromontips);
