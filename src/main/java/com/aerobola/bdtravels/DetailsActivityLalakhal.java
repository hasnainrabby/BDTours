...
public class DetailsActivityLalakhal extends AppCompatActivity {
    ...
    int[] sampleImages = {
            R.drawable.lalakhal5,
            R.drawable.lalakhal3,
            R.drawable.lalakhal2,
            R.drawable.lalakhal1
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputStream inputStream = getResources().openRawResource(R.raw.lalakhal_intro);
        ...
        inputStream = getResources().openRawResource(R.raw.lalakhal_kivabejaben);
        ...
        inputStream = getResources().openRawResource(R.raw.lalakhal_kivabepousaben);
        ...
        inputStream = getResources().openRawResource(R.raw.lalakhal_kothaithakben);
        ...
        inputStream = getResources().openRawResource(R.raw.lalakhal_khabar);
        ...
        inputStream = getResources().openRawResource(R.raw.lalakhal_vromontips);
