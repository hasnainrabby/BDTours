...
public class DetailsActivityLalon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputStream inputStream = getResources().openRawResource(R.raw.lalon_intro);
        ...
        inputStream = getResources().openRawResource(R.raw.lalon_kivabejaben);
        ...
        inputStream = getResources().openRawResource(R.raw.lalon_kivabepousaben);
        ...
        inputStream = getResources().openRawResource(R.raw.lalon_kothaithakben);
        ...
        inputStream = getResources().openRawResource(R.raw.lalon_khabar);
        ...
        inputStream = getResources().openRawResource(R.raw.lalon_vromontips);
