...
public class DetailsActivityModhutila extends AppCompatActivity {
    ...
    int[] sampleImages = {
            R.drawable.modhutila1,
            R.drawable.modhutila3,
            R.drawable.modhutila4,
            R.drawable.modhutila5
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolBarTitle.setText("*** মধুটিলা ইকো পার্ক ***");
        ...
        InputStream inputStream = getResources().openRawResource(R.raw.modhutila_intro);
        ...
        inputStream = getResources().openRawResource(R.raw.modhutila_kivabejaben);
        ...
        inputStream = getResources().openRawResource(R.raw.modhutila_kivabepousaben);
        ...
        inputStream = getResources().openRawResource(R.raw.modhutila_kothaithakben);
        ...
        inputStream = getResources().openRawResource(R.raw.modhutila_khabar);
        ...
        inputStream = getResources().openRawResource(R.raw.modhutila_vromontips);
