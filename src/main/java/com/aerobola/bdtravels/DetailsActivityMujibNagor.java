...
public class DetailsActivityMujibNagor extends AppCompatActivity {
    ...
    int[] sampleImages = {
            R.drawable.mujibnagar1,
            R.drawable.mujibnagar2,
            R.drawable.mujibnagar4,
            R.drawable.mujibnagar6,
            R.drawable.mujibnagar7
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputStream inputStream = getResources().openRawResource(R.raw.mujibnogor_intro);
        ...
        inputStream = getResources().openRawResource(R.raw.mujibnogor_kivabejaben);
        ...
        inputStream = getResources().openRawResource(R.raw.mujibnogor_kivabepousaben);
        ...
        inputStream = getResources().openRawResource(R.raw.mujibnogor_kothaithakben);
        ...
        inputStream = getResources().openRawResource(R.raw.mujibnogor_khabar);
        ...
        inputStream = getResources().openRawResource(R.raw.mujibnogor_vromontips);
