...
public class DetailsActivityPanthumai extends AppCompatActivity {
    ...
    int[] sampleImages = {
            R.drawable.panthumai1,
            R.drawable.panthumai2,
            R.drawable.panthumai3,
            R.drawable.panthumai4,
            R.drawable.panthumai5
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputStream inputStream = getResources().openRawResource(R.raw.panthumai_intro);
        ...
        inputStream = getResources().openRawResource(R.raw.panthumai_kivabejaben);
        ...
        inputStream = getResources().openRawResource(R.raw.panthumai_kivabepousaben);
        ...
        inputStream = getResources().openRawResource(R.raw.panthumai_kothaithakben);
        ...
        inputStream = getResources().openRawResource(R.raw.panthumai_khabar);
        ...
        inputStream = getResources().openRawResource(R.raw.panthumai_vromontips);
