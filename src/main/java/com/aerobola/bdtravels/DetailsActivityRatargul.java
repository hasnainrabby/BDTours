...
public class DetailsActivityRatargul extends AppCompatActivity {
    ...
    int[] sampleImages = {
            R.drawable.ratargul1,
            R.drawable.ratargul2,
            R.drawable.ratargul3,
            R.drawable.ratargul4,
            R.drawable.ratargul5
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputStream inputStream = getResources().openRawResource(R.raw.ratargul_intro);
        ...
        inputStream = getResources().openRawResource(R.raw.ratargul_kivabejaben);
        ...
        inputStream = getResources().openRawResource(R.raw.ratargul_kivabepousaben);
        ...
        inputStream = getResources().openRawResource(R.raw.ratargul_kothaithakben);
        ...
        inputStream = getResources().openRawResource(R.raw.ratargul_khabar);
        ...
        inputStream = getResources().openRawResource(R.raw.ratargul_vromontips);
