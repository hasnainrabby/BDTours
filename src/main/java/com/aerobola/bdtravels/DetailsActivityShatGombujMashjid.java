...
public class DetailsActivityShatGombujMashjid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputStream inputStream = getResources().openRawResource(R.raw.satgombuj_intro);
        ...
        inputStream = getResources().openRawResource(R.raw.satgombuj_kivabejaben);
        ...
        inputStream = getResources().openRawResource(R.raw.satgombuj_kivabepousaben);
        ...
        inputStream = getResources().openRawResource(R.raw.satgombuj_kothaithakben);
        ...
        inputStream = getResources().openRawResource(R.raw.satgombuj_khabar);
        ...
        inputStream = getResources().openRawResource(R.raw.satgombuj_vromontips);
